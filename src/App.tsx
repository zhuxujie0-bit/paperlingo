...
function App() {
  ...
  // PDF 页面宽度跟随阅读区实际宽度（平板竖屏/横屏/桌面都铺满，不留大边距）
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      setPageWidth(Math.max(300, Math.floor(el.clientWidth - padding)))
    }
    update()
