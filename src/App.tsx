...
function App() {
  ...
  const [notice, setNotice] = useState('拖选一个英文词会自动查词；拖选一句英文后可选择分析句法。')
  ...
  const inspectSelection = () => window.setTimeout(() => {
